                ...
                <div className="mt-12">
                    <ul className="flex justify-center gap-8">
                        {team.map((item, idx) => (
                            ...
                            <li key={idx} className="transition-transform transform hover:scale-105">
                                ...
                                <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center text-center">
                                    ...
                                    <div className="mt-4 flex gap-4 justify-center">
                                        <a href={item.github} target="blank" className="text-gray-400 hover:text-gray-500 transition-colors duration-150 relative">
                                        ...
                                        <a href={item.linkedin} target="blank" className="text-gray-400 hover:text-gray-500 transition-colors duration-150 relative">
                                            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 48 48">
                                                <g fill="currentColor">
