            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl">
                    ...
                    <p className="text-gray-600 mt-3 text-lg">
                        Hola! Somos el equipo <span className="font-bold text-indigo-600 animate-pulse">SeedMinds</span>. Estudiantes de la Universidad Continental, nos apasiona la tecnología y los retos, por eso hemos creado esta plataforma. ¡Conócenos!
                    </p>
                </div>
                <div className="mt-12">
                        ...
                        {team.map((item, idx) => (
                            <li key={idx} className="transition-transform transform hover:scale-105 relative">
                                <a 
                                    ...
                                    className="block w-full h-full" // Asegúrate de que el enlace cubra toda la tarjeta
                                >
